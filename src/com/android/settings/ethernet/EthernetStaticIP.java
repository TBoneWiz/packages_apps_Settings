...
public class EthernetStaticIP  extends SettingsPreferenceFragment
    ...
    private static final String KEY_NETWORK_PREFIX_LENGTH = "network_prefix_length";
    ...
    private void updateIpSettingsInfo() {
        ...
        setStringSummary(KEY_NETWORK_PREFIX_LENGTH, Integer.toString(getPrefixLength()));
    }
    ...
    private boolean saveIpSettingsInfo() {
        if (mUseStaticIpCheckBox.isChecked()) {
            ...
            preference = (EditTextPreference)findPreference(KEY_NETWORK_PREFIX_LENGTH);
